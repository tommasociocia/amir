...
window.NetBuilderLevelFactories.level4 = ({ validateFirewall, firewallPairs }) => ({
  ...
  objective: [
    ...
    "",
    "Requisiti:",
    "- esattamente 2 PC collegati allo switch",
    "- switch collegato al firewall",
    "- firewall collegato al router",
    "- router collegato a Internet",
    "- nessun collegamento diretto LAN -> router/Internet",
    "",
    "La prova mostra il traffico in uscita e blocca quello in ingresso.",
  ].join("\n"),
  checks: ["2 PC esatti collegati allo switch", "Firewall tra LAN e router", "Router verso Internet", "Nessun bypass del firewall"],
